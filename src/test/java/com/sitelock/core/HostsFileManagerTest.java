...
/**
 * Testa a manipulação do bloco de marcadores puramente em memória
 * (sem tocar no /etc/hosts real).
 */
class HostsFileManagerTest {
    ...
    void addCreatesBlockWhenMissing() {
        ...
        // P1: IPv6 também é bloqueado (antes só IPv4, o que deixava passar AAAA).
    ...
    void addComplementsLegacyIpv4OnlyEntries() {
        // Bloco legado (Etapa 1 original) sem ::1: re-block deve completar.
