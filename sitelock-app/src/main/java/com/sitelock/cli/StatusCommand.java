...
/**
 * siteblock status — lista bloqueios. Limpa expirados só se puder escrever no hosts.
 */
        ...
        try {
            if (service.isHostsWritable()) {
                ...
                if (pending > 0) {
                    ...
                    System.out.println(CliSupport.elevationHint("status")
                            + " para concluir a limpeza no hosts.");
                }
            }
